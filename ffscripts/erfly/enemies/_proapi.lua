...
--WTF is this function btw?
-- it's a function for making a value smoothly interpolate back and forth between two values based on a timer :)
...
function mod:Shuffle(tbl)
    for i = 1, #tbl * 2 do
        local a = math.random(#tbl)
        local b = math.random(#tbl)
